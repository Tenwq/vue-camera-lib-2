<template>
  <div :class="{ 'fullscreen-overlay': fullscreen, '': !fullscreen }" id="webcam-ui">
    <Webcam ref="webcam" @init="webcamInit" @clear="clear" @stop="stop" @start="start" @pause="pause" @resume="resume"
      @error="error" @unsupported="unsupported" @photoTaken="photoTakenEvent" :shutterEffect="fullscreen" />
...
<style scoped src="../dist/output.css"></style>
